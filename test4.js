...
function Devices(name, diagonal, brand, power) {
this.name = name,
...
Devices.prototype.connected = function() {
    console.log(`${this.name} включён в сеть`);
    this.connect = true;
    powerConsumption += this.power;
}
Devices.prototype.unconnected = function() {
...
const monoblock = new Devices('monoblock', 27, 'HP', 120 );
monoblock.connected();
console.log(monoblock);
const laptop = new Devices('laptop', 17, 'Asus', 50);
laptop.unconnected();
console.log(laptop);
